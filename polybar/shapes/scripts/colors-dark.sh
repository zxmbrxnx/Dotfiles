...
change_color() {
	# polybar
	sed -i -e 's/background = #.*/background = #181926/g' $PFILE
...
if  [[ $1 = "--amber" ]]; then
	...
	SH1="#181926"	SH2="#1e2030"	SH3="#24273a"	SH4="#363a4f"
	SH5="#494d64"	SH6="#5b6078"	SH7="#6e738d"	SH8="#8087a2"
	change_color
else
	cat <<- _EOF_
	...
	--red	--teal		--yellow	--catppucin-mocha
	_EOF_
fi
